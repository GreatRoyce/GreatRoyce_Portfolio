...
function HeroSection() {
  ...
  // Split text into lines for better responsive layout
  const heroText = "Expert MERN Developer for Modern Innovations";
  const words = heroText.split(" ");
  
  // Group words for better line breaks
  const line1 = words.slice(0, 2); // "Expert MERN"
  const line2 = words.slice(2, 4); // "Developer for"
  const line3 = words.slice(4);    // "Modern Innovations"
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col justify-center min-h-[80vh] lg:min-h-[90vh] py-8 lg:py-16">
          ...
          <div className="w-full lg:w-3/5 xl:w-1/2">
            {/* Main Heading with improved responsive layout */}
            <motion.div
            ...
            >
              <motion.div variants={buttonVariants}>
                <Buttons
                  variant="primary"
                  className={`
                    w-full sm:w-auto min-w-[140px] text-center
                    ${
                      isDarkMode
